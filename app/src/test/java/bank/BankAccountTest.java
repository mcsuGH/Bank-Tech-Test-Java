...
public class BankAccountTest {
    ...
    @Test public void deposit_InNewAccountOnce() {
        BankAccount acc = new BankAccount();
        acc.deposit(BigDecimal.valueOf(1000), LocalDateTime.now());
    ...
    @Test public void deposit_InNewAccountTwice() {
        BankAccount acc = new BankAccount();
        acc.deposit(BigDecimal.valueOf(1000), LocalDateTime.now());
        acc.deposit(BigDecimal.valueOf(500), LocalDateTime.now());
    ...
    @Test public void deposit_InNewAccount_ThenWithdraw() {
        BankAccount acc = new BankAccount();
        acc.deposit(BigDecimal.valueOf(1000), LocalDateTime.now());
        acc.withdraw(BigDecimal.valueOf(500), LocalDateTime.now());
